...
class Estudiante:
    def __init__(self, nombre, apellido_paterno, apellido_materno, año_nacimiento, carrera , año_curso):
        self.nombre = nombre
        self.apellido_paterno = apellido_paterno
        self.apellido_materno = apellido_materno
        self.año_nacimiento = año_nacimiento
        self.carrera = carrera
        self.año_curso = año_curso

    def generar_matricula(self):
       
        año_nacimiento = str(self.año_nacimiento)[-2:]
        año_curso = str(self.año_curso)[-2:]
        ...
        matricula = tres_primeras_letras_carrera + año_curso + año_nacimiento + primera_letra_nombre + tres_letras_apellido_paterno + tres_letras_apellido_materno + tres_digitos_aleatorios
